using ItemService_Borders.Enums;
...
namespace ItemService_Borders.Shared
{
    public class UseCaseResponse<T>
    {
        ...
        public static UseCaseResponse<T> BadGateway(ErrorMessage errorMessage) => new(UseCaseResponseKind.BadGateway, "Bad Gateway", [errorMessage]);
        ...
        public static UseCaseResponse<T> NotFound(ErrorMessage errorMessage) => new(UseCaseResponseKind.NotFound, "Data not found", [errorMessage]);

        public static UseCaseResponse<T> InternalServerError(ErrorMessage errorMessage) => new(UseCaseResponseKind.InternalServerError, "Internal Server Error", [errorMessage]);

        public static UseCaseResponse<T> NoContent() => new(UseCaseResponseKind.NoContent);
